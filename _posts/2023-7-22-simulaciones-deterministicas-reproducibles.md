...
<p style='text-align: justify;'>La segunda cosa que necesitamos es definir los parámetros de la función que, dado el estado del mundo en un momento en el tiempo, calcula el estado del mundo en el siguiente fotograma. Por lo general estos parámetros van a ser el tiempo que ha pasado desde el último fotograma y los botones del mando o teclado que el jugador ha pulsado desde entonces. Para el servidor de un juego online no hay jugadores pulsando botones, pero sí todos los mensajes que llegan desde la red, de cada uno de los jugadores conectados.</p>
