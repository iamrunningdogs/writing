...
<p style='text-align: justify;'>Si el juego es muy simple y uno se quiere poner creativo se puede buscar hacer el formato más eficiente. Por ejemplo, en World of Traps: Speedrun Edition el juego estaba bloqueado a 60 fotogramas por segundo, de forma que sabíamos que el tiempo entre fotogramas era siempre 0,0167 segundos, y sólo tenía 4 inputs, de forma que podíamos representarlo con 4 bits. Esto significa que se puede guardar una hora de grabación de World of Traps en poco más de 105 kilobytes de memoria.</p>
